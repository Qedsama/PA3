...
for epoch in range(opt.n_epochs):
    for i, (imgs, labels) in enumerate(dataloader):
        ...
        d_real_loss = adversarial_loss(validity_real, jt.ones_like(validity_real))

        validity_fake = discriminator(gen_imgs.stop_grad(), gen_labels)
        d_fake_loss = adversarial_loss(validity_fake, jt.zeros_like(validity_fake))
